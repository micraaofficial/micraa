        ...
        <div class="services-container">
            <div class="service-grid">
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="gig-card"> <img src="<?php echo e(asset('storage/' . $service->image1)); ?>" class="gig-image">
                        <div class="gig-body">
                            <div class="gig-title"> <?php echo e($service->title); ?> </div>
                            <div class="seller-left"> <img
                                    src="<?php echo e($service->user && $service->user->profile_photo ? asset('storage/' . $service->user->profile_photo) : asset('images/default-avatar.png')); ?>"
                                    class="seller-dp"> <span class="seller-name">
                                    <?php echo e($service->user->name ?? 'Seller'); ?> </span> </div>
                            <div class="gig-bottom">
                                ...
                                <div class="right-price">
                                    <div class="gig-price"> <span class="usd">USD</span> <span
                                            class="amount">$<?php echo e(intval($service->price)); ?></span> <span
...
<?php /**PATH /home/u178846379/domains/micraa.com/public_html/micraa/resources/views/home.blade.php ENDPATH**/ ?>