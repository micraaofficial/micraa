...
<?php if(Auth::check() && Auth::user()->avatar): ?>
    <img src="<?php echo e(asset('storage/'.Auth::user()->avatar)); ?>" class="avatar-img">
<?php else: ?>
...
<span><?php echo e(Auth::check() ? Auth::user()->name : 'Guest'); ?></span>
...
<div class="card-number"><?php echo e($totalListings); ?></div>
</div>
...
<div class="card-number">$ <?php echo e($earnings ?? 0); ?></div>
</div>
...
<?php /**PATH /home/u178846379/domains/micraa.com/public_html/resources/views/dashboard.blade.php ENDPATH**/ ?>