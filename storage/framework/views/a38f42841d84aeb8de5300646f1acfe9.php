...
<?php if(Auth::user()->avatar): ?> <img src="<?php echo e(asset('storage/'.Auth::user()->avatar)); ?>">
<?php else: ?>
...
<label>Name</label> <input type="text" name="name" value="<?php echo e(Auth::user()->name); ?>">

<label>Email</label> <input type="email" name="email" value="<?php echo e(Auth::user()->email); ?>">

<label>New Password</label> <input type="password" name="password" placeholder="Leave empty if you don't want to change">

<label>Profile Bio</label>

<textarea name="bio"><?php echo e(Auth::user()->bio); ?></textarea>
...
<?php /**PATH /home/u178846379/domains/micraa.com/public_html/resources/views/settings.blade.php ENDPATH**/ ?>